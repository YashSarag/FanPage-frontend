...
import birthday_cake from '../assets/birthday-cake.png'
...
function BirthdayPage(){
  ...
  return (
    <div className='birthday-bg flex justify-center items-center w-[100%] max-w-[1160px] mx-auto h-full'>
        {
            celebrate ? (<div>
                <Confetti/>
                <BirthdayCard/>
                ...
                <div className='relative'>
                    <div className='flex flex-col justify-center items-center'>
                        ...
                        <div className='cake-on-way text-center mb-[30px] text-[32px] font-bold h-full timer-caption-3 hidden tracking-[1px] bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500'>
                            Cake on Way...!
                        </div>
                        <div className='birthday-bg-container timer-container grid grid-cols-[1fr,0fr,1fr,0fr,1fr,0fr,1fr] place-items-center fanwall-colors max-w-max px-[70px] py-[50px] rounded-2xl select-none'>
                            <div className='flex flex-col items-center gap-[10px]'>
                                <div className='birthday-bg-box bg-slate-100 text-[48px] h-[80px] w-[125px] grid place-items-center rounded-md'>{remainingTime.days}</div>
                            ...
                            <div className='flex flex-col items-center gap-[10px]'>
                                <div className='birthday-bg-box bg-slate-100 text-[48px] h-[80px] w-[125px] grid place-items-center rounded-md'>{remainingTime.hours}</div>
                            ...
                            <div className='flex flex-col items-center gap-[10px]'>
                                <div className='birthday-bg-box bg-slate-100 text-[48px] h-[80px] w-[125px] grid place-items-center rounded-md'>{remainingTime.minutes}</div>
                            ...
                            <div className='flex flex-col items-center gap-[10px]'>
                                <div className='birthday-bg-box bg-slate-100 text-[48px] h-[80px] w-[125px] grid place-items-center rounded-md'>{remainingTime.seconds}</div>
                    ...
                    <img src={birthday_cake}
                        className='birthday-cake absolute left-[50%] translate-x-[-50%] bottom-[-90px] w-[200px] hidden'
                    />
                </div>
            )
        }
